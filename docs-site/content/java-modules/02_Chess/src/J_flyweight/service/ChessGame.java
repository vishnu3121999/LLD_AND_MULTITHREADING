...
public abstract class ChessGame {
    ...
    public boolean hasPositionMoved(J_flyweight.model.Position position) {
        return movedPositionKeys.contains(positionKey(position));
    }

    public void markPositionMoved(J_flyweight.model.Position position) {
        movedPositionKeys.add(positionKey(position));
    }

    private String positionKey(J_flyweight.model.Position position) {

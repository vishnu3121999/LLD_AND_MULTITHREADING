...
import F_Concurrency1.payment.PaymentStrategyFactory;
import F_Concurrency1.pricing.HourlyFeeCalculationStrategy;
import F_Concurrency1.service.ParkingLotFacade;
import F_Concurrency1.strategy.assignment.FirstAvailableSlotAssignmentStrategy;
...
public class Main {
    public static void main(String[] args) {
        try {
            System.out.println("=== Parking Lot Concurrency1 Demo ===");

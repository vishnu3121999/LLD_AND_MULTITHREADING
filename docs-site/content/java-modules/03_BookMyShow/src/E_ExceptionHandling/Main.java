...
public class Main {
    ...
    private static void runDemo() {
        ...
        String ticketId = facade.selectSeats("user-1", avatarPvrShowId, selectedShowSeatList);
        ...
        tryOperation("Selecting the same seats again", () -> facade.selectSeats(
                "user-2",
                avatarPvrShowId,
                selectedShowSeatList
        ));
